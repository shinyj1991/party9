...
<script>
  ...
  export default {
    ...
    mounted() {
      this.$refs.container.addEventListener('touchstart', this.detectWindowTouchstart);
      this.$refs.container.addEventListener('touchmove', this.detectWindowTouchmove);
